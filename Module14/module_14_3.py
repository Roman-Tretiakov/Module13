...
async def get_buying_list(message: types.Message):
    for i in range(1, 5):
        product = FSInputFile(f'bank{i}.png', 'rb')
        await message.answer_photo(product, f'Название: Product{i} | Описание: описание {i} '
                                            f'| Цена: {i * 100} руб.', show_caption_above_media=True)
